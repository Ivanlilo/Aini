...
|=>Rn yid [Show your ID] 
|=>Sider [Mengunci Titik Pembaca] ==> Perbaikan
|=>Recheck [Melihat Sider] ==> Perbaikan
...
Bots=[mid,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u4fea079f7b398444bea1c51ec2301c90"]
admin=["u1f41296217e740650e0448b96851a3e2","ud25513a3d16860cb5fe6416238540577"]
wait = {
    'protect':True,
    'protectinv':True,
    'protectqr':True,
			...
			cl.sendText(msg.to,"Done")
              ...
              if msg.from_ in admin:
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to, "Dasar sider lucknut :v \nKetik 「Recheck」 gua bakal ngasih tau siapa sidernya")
                    try:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "T E R S A N G K A %s\n------------------\n\nT E R C Y D U K\n%s----------------\n\nTanggal Dan Jam:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Belom di set dodol 􏿿􀜁􀅔Har Har􏿿\nKetik 「Sider」 buat lihat siapa sider lucknut :v")
#-----------------------------------------------
